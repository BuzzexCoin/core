...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BuzzexCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BuzzexCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BuzzexCoin features */
        {"buzzexcoin", "masternode", &masternode, true, true, false},
        {"buzzexcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"buzzexcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"buzzexcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"buzzexcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"buzzexcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"buzzexcoin", "startmasternode", &startmasternode, true, true, false},
        {"buzzexcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"buzzexcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"buzzexcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"buzzexcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"buzzexcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"buzzexcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"buzzexcoin", "mnbudget", &mnbudget, true, true, false},
        {"buzzexcoin", "preparebudget", &preparebudget, true, true, false},
        {"buzzexcoin", "submitbudget", &submitbudget, true, true, false},
        {"buzzexcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"buzzexcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"buzzexcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"buzzexcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"buzzexcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"buzzexcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"buzzexcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"buzzexcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"buzzexcoin", "mnsync", &mnsync, true, true, false},
        {"buzzexcoin", "spork", &spork, true, true, false},
        {"buzzexcoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"buzzexcoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"buzzexcoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"buzzexcoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"buzzexcoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"buzzexcoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> buzzexcoin-cli " + methodname + " " + args + "\n";
}

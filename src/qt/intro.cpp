...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BuzzexCoin Core"),
     ...
     * override -datadir in the buzzexcoin.conf file in the default data directory
     * (to be consistent with buzzexcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

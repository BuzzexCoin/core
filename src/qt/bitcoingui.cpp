                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BuzzexCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and buzzexcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BuzzexCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BuzzexCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BuzzexCoin"));
    ...
    openAction->setStatusTip(tr("Open a buzzexcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BuzzexCoin Core help message to get a list with possible BuzzexCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BuzzexCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BuzzexCoin network", "", count));
}
...
{
    QString strTitle = tr("BuzzexCoin Core"); // default title

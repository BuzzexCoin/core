...
/** Utility functions used by the BuzzexCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BZX addresses in monospace font
...
// Parse "buzzexcoin:" URI into recipient object, return true on successful parsing

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BuzzexCoin Core buzzexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  buzzexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded buzzexcoin transaction") + "\n" +
                               "  buzzexcoin-tx [options] -create [commands]   " + _("Create hex-encoded buzzexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded buzzexcoin transaction

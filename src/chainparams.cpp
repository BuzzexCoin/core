...
// Copyright (c) 2017-2018 The BuzzexCoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0,      uint256("0x00000a2b5ba7e3155c174ae731f1cb314779474cde57085497534002eef84ecc"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1537191500, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1537191500;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 242160;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000a2b5ba7e3155c174ae731f1cb314779474cde57085497534002eef84ecc"));
        assert(genesis.hashMerkleRoot == uint256("0xd7c31a9c9010aea45bd3a62fd9795ef3d1f790c84ed8acac4923f26a1d9f3dbf"));

        // DNS Seeding
        //vSeeds.push_back(CDNSSeedData("seed1", "seed1"));
        ...
        strSporkKey = "0491d15e9967e21e14faddaa92c0250c77bd7c005885a5b8c5a5ab0a5028f205e72b3b473dcffb5d47d9bb1ab832eb753f7646fb51006480aacb11888155ab3550";
        strMasternodePoolDummyAddress = "GfLUnpLxWwBFsoQfHwBMCqqpZyj5b6ENcT";
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1537191442;
        genesis.nNonce = 296213;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000001c4ca9d8872374286eaad47fb28d556ef0af802f8731401604ccde2c269"));

        vFixedSeeds.clear();
        vSeeds.clear();

        // Testnet BuzzexCoin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet BuzzexCoin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet BuzzexCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet BuzzexCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet buzzexcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // BuzzexCoin: 1 minutes

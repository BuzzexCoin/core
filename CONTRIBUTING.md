Contributing to BuzzexCoin Core
==================================

The BuzzexCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BuzzexCoin Core project, and is not to be
confused with overall BuzzexCoin Network Protocol consensus changes.

Whether a pull request is merged into BuzzexCoin Core rests with the project merge
...
Patches that change BuzzexCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BuzzexCoin consensus, it must have been
...
The project leader is the release manager for each BuzzexCoin Core release.

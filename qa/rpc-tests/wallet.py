...
#   c) node1 mines 32 blocks, so now node 0 has 500000BZX, node 1 has 4250BZX, node2 has none.
#   d) node0 sends 601 BZX to node2, in two transactions (301 BZX, then 300 BZX).

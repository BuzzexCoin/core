...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/buzzexcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/buzzexcoin-cli.cpp \
           src/buzzexcoin-tx.cpp \
           src/buzzexcoin.cpp \
           src/db.cpp \
           ...
           src/qt/buzzexcoin.cpp \
           src/qt/buzzexcoinstrings.cpp \
...
RESOURCES += src/qt/buzzexcoin.qrc src/qt/buzzexcoin_locale.qrc

TRANSLATIONS += src/qt/locale/buzzexcoin_bg.ts \
                src/qt/locale/buzzexcoin_de.ts \
                src/qt/locale/buzzexcoin_en.ts \
                src/qt/locale/buzzexcoin_es.ts \
                src/qt/locale/buzzexcoin_fi.ts \
                src/qt/locale/buzzexcoin_fr.ts \
                src/qt/locale/buzzexcoin_it.ts \
                src/qt/locale/buzzexcoin_ja.ts \
                src/qt/locale/buzzexcoin_pl.ts \
                src/qt/locale/buzzexcoin_pt.ts \
                src/qt/locale/buzzexcoin_ru.ts \
                src/qt/locale/buzzexcoin_sk.ts \
                src/qt/locale/buzzexcoin_sv.ts \
                src/qt/locale/buzzexcoin_vi.ts \
                src/qt/locale/buzzexcoin_zh_CN.ts \
                src/qt/locale/buzzexcoin_zh_TW.ts

...
This means one can have an always-on buzzexcoind instance running, and another local buzzexcoind/buzzexcoin-qt instance which connects to this node and receives blocks from it.

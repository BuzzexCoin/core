...
This mechanism has been integrated into Bitcore-Node-BuzzexCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/buzzexcoin/insight-api-buzzexcoin#web-socket-api](https://github.com/buzzexcoin/insight-api-buzzexcoin#web-socket-api)
* API: [https://github.com/buzzexcoin/insight-api-buzzexcoin#swifttx-transactions](https://github.com/buzzexcoin/insight-api-buzzexcoin#swifttx-transactions)
...
By default, the BuzzexCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BuzzexCoin Core daemon:

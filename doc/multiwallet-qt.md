...
In order to support loading of multiple wallets in buzzexcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is buzzexcoin.cpp.
...
Changes to buzzexcoin.cpp
----------------------
buzzexcoin.cpp is the entry point into buzzexcoin-qt, and as such, will require some minor modifications to provide hooks for
